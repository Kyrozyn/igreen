    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">List Pelaporan Aktif</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">Menu</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">List Pelaporan</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-vcenter">
                        ...
                        <tr>
                            ...
                            <th>Nama Laporan</th>
                            <th>Status</th>
                            <th class="d-none d-sm-table-cell" style="width: 30%;">Dilaporkan Tanggal</th>
